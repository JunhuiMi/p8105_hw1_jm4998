...
The mean of x is `r mean(df_2$x)`, the median of x is `r median(df_2$x)`, and the  standard deviation of x is `r sd(df_2$x)`.

The proportion of cases for which x + y > 1 is `r sum(df_2$num)/500`
